    ...
    <body>
        ...
        <div id="create-cita" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.cita}" method="POST">
                <fieldset class="form">
                    <f:all bean="cita" except="fechaHora" />
                    <div class='fieldcontain required'>
                    <label for="fechaHora">Fecha Hora: <span class='required-indicator'>*</span> </label>

                    <g:datePicker name="fechaHora" value="${cita?.fechaHora}" />
                </div>
                </fieldset>
